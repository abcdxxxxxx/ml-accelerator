...
VL_ATTR_COLD void Vpe_tb___024root___ctor_var_reset(Vpe_tb___024root* vlSelf) {
    ...
    vlSelf->pe_tb__DOT__reset = VL_RAND_RESET_I(1);
    vlSelf->pe_tb__DOT__enable = VL_RAND_RESET_I(1);
    vlSelf->pe_tb__DOT__a_in = VL_RAND_RESET_I(8);
    vlSelf->pe_tb__DOT__b_in = VL_RAND_RESET_I(8);
    vlSelf->pe_tb__DOT__dut__DOT__acc = VL_RAND_RESET_I(32);
